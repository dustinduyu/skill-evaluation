...
7. **建立数据记录表**
   ...
   - 至少保存：run_id、case_id、dataset_split、input_ref、expected_ref、actual_output_ref、layer、metric_key、judge_type、score、pass_fail、error、duration_ms、cost、artifact_path、review_status、created_at。
